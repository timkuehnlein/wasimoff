...
declare module "pull-lend-stream" {
    import type { Duplex, Sink, Source, Error } from "@types/pull-stream";
  
    declare function lendStream<In, Out>(): Lender<In, Out>;
    ...
    export type Borrower<In, Out> = (err: Error | null, subStream: SubStream<In, Out>) => void;
  
    export type SubStream<In, Out> = Duplex<In, Out> & { close: (err?: Error) => void };
